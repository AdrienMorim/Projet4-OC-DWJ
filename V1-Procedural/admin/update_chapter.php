...
<html lang="fr">
    ...
    <body>
        <h1>Administration - Modifier un chapitre</h1>
        ...
        <h3>Mise à jour du chapitre <?= htmlspecialchars($data['title']); ?></h3>

        <form action="update.php?chapter=<?= $_GET['chapter']; ?>" method="POST">
            <p>
