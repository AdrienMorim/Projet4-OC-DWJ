<?php $title = 'Mise à jour du chapitre ' . $chapter['id'] . ' - Billet simple pour l\'Alaska'; ?>
...
<?php ob_start(); ?>
    ...
    <div id="banner" class="row banner-page">
        ...
        <div id="banner-title" class="col-lg-8 col-md-10 col-8 offset-lg-2  banner-title-page">
            ...
            <h2>Éditer le chapitre: <?= $chapter['title']; ?></h2>
        </div>
    </div>
...
<?php ob_start(); ?>
    <div id="inner" class="container col">
        <div id="admin" class="col-lg-10 offset-lg-1">
            <form action="index.php?action=updateChapter&amp;id_chapter=<?= $chapter['id']; ?>" method="POST">
                <div class="col-lg-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="title" class="form-control" id="title" value="<?= $chapter['title']; ?>"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="content" class="col-lg-3">Chapitre</label>
                        <div class="col-lg-9">
                            <textarea name="content" id="content" class="form-control"><?= $chapter['content']; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
